...
@if(request('mapel_id') && $siswa->count() > 0 && $kelas)
<div class="alert alert-info">
    <i class="bi bi-info-circle"></i> <strong>Mata Pelajaran:</strong> {{ $mapelGuru->where('mapel_id', request('mapel_id'))->first()->mapel->nama_mapel ?? '' }} | 
