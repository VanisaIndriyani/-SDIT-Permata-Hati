...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $siswaList = [
            ['nama' => 'AHMAD KENZEI PARAMA RUHMADHA', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'AKHTAR ALKHALIFI ADYATAMA TAIM', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'AL IRSYAD ABIDZAR FAIRUZ', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'ALFATHIER RAMADHAN AMARULLAH', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'ASHILA PERMANA NOERSAM ZA', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'BUNGA PUTRI IRAWAN', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'HAFIZA KHAIRA GANI', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'INDY AUDREY FAHLEVY', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'KHAIRA ELVINA DZAKIRA', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'KHAIRUNNISA NUR AZIZAH', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'KINANTHY ZARRA ADHELIA', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'KIRANI PUTRI DINANTI', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'LETIZIA ALMA NURSYIFA', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'MALIK ABDURRAHIEM ROBIY', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'MAULANA YUSUF YUSTISIO', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'MAZAYA NUHA AMARA', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'MOHAMMAD JABAR', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'MUCHAMAD KHAIRAN ARSYA KAMIL NURFIANSYAH', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'MUHAMMAD SYABIL ELFATHIN AFRIYANTO', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'NAJWA AL JAZARI ARETA KALIFA', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'NANCY AULIA RAHMAN', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'RADISTY JUNINDIA KURNIAWAN PUTRI', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'RAZA SAM\'ANI FEBRIANSYAH', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'SULTHAN ABDURRAHMAN TALITS', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'SYABIL ADYASTA RAHARJA', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'MUHAMAD KAISAR RAMADHAN', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'M FADLAN IBNU MALIK', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'ALZENA AZALIA ZARA', 'jenis_kelamin' => 'Perempuan'],
            ['nama' => 'AKHTAR ANDANESH ALGHANIIY', 'jenis_kelamin' => 'Laki-laki'],
            ['nama' => 'ABDU RAZIQ DARY ABIYYU', 'jenis_kelamin' => 'Laki-laki'],
        ];

        $siswaRecords = [];
        foreach ($siswaList as $index => $siswaData) {
